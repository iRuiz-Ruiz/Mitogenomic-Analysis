...
Gene1_pos3 = 3-789\3;
```
Contrastingly, in the example .cfg (above), I don't have the exact codon positions, because I pass it through GBLOCKs and selected the most conserved regions. 
